Feature: Payments
  ...
  Background:
    ...
    Given the following ezinvoices exist
      ...
      | 1235       | greger bb    | södra 2         | 413         | gbg          | b@mail.com    | ezdef       | 3000   | felix          | 10    | 2017-12-02 | false | 9999    | 9999       | false       | 0.09     |
  ...
  Scenario: I see the payments
    ...
    And I should see "Din avgiftsnivå vid skapandet av utbetalningen: 9%"
    And I should see "Vår avgift: -270"
    And I should see "Ny bruttolön: 2730 SEK"
    And I should see "Bruttolön inkl. semesterersättning(12%): 3058 SEK"
    And I should see "Skatt: -917 SEK"
    Then I should see "Nettolön(lön efter skatt): 2141 SEK"
    And I should see "Lön som betalas ut: 2141 SEK"
    Given I am on the dashboards page
    And I click "Utbetalningar"
