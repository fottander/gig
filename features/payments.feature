Feature: Payments
  ...
  Scenario: I see the payments
    ...
    And I should see "Din avgiftsnivå vid skapandet av fakturan: 9%"
    And I should see "Vår avgift: -270"
    And I should see "Ny bruttolön inkl sem. ers: 3155 SEK"
    And I should see "Skatt: -947 SEK"
    Then I should see "Nettolön (lön efter skatt): 2208 SEK"
    And I should see "Utbetald summa: 2208 SEK"
