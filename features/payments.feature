Feature: Payments
  ...
  Background:
    ...
    Given the following invoices exist
      | description | amount  | user_reference | terms | active | company_id | updated_at | paid  | user_id    | profile_id | salary_paid | user_fee |
      | abc         | 3000    | felix          | 30    | true   | 9999       | 2017-11-01 | false | 9999       | 9999       | true        | 0.09     |
      | def         | 3000    | felix          | 30    | true   | 9999       | 2017-11-02 | false | 9999       | 9999       | false       | 0.09     |
