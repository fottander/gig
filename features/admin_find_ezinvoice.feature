Feature: Admin find ezinvoices
  ...
  Background:
    ...
    Given the following ezinvoices exist
      ...
      | 1234       | greger ab    | södra 1         | 412         | gbg          | a@mail.com    | abc fakt    | 120    | felix          | 10    | false | 9999       |
      | 1235       | greger bb    | södra 2         | 413         | gbg          | b@mail.com    | def fakt    | 120    | felix          | 10    | false | 9998       |
      | 1233       | greger cc    | södra 3         | 414         | gbg          | c@mail.com    | ghi fakt    | 120    | felix          | 10    | true  | 9998       |
