...
Background:
  ...
  Scenario: I see the invoices for under 25 with annat förbunds kollektivavtal
    ...
    Then I should see "Lön som betalas ut: 731 SEK"
    ...
    And I should see "Vår avgift: -100"
    And I should see "Ny bruttolön inkl sem. ers: 1044 SEK"
    And I should see "Skatt: -313 SEK"
    And I should see "Utbetald summa: 731 SEK"
    And I should not see "pensionsinbetalning"
    ...
    And I should see "Sociala avgifter(0.61%): 7"
    ...
    And I should see "Vår avgift: -100 SEK"
    And I should see "Arbetsgivaravgifter(31,42%): -328 SEK"
    And I should see "Sociala avgifter(0.61%): -6 SEK"
    And I should not see "pensionsinbetalning"
    And I should see "Bruttolön inkl sem. ers: 1044 SEK"
    And I should see "Skatt: -313 SEK"
    And I should see "Nettolön att utbetala: 731 SEK"

  Scenario: I see the invoices for 25-65 with annat förbunds kollektivavtal
    Given I am logged in as user "felix@mail.com"
    Given I am on the dashboards page
    And I click "Visa"
    And I should see "Varav pensionsinbetalning: 45 SEK"
    Then I should see "Lön som betalas ut: 731 SEK"
    And I click "Utbetalningar"
    And I click "2018-01-01 00:00"
    And I should see "Bruttolön: 1000"
    ...
    And I should see "Utbetald summa: 731 SEK"
    And I should see "Arbetsgivaravgifter(31,42%): 328 SEK"
    And I should see "Sociala avgifter(4.91%): 51 SEK"
    And I should see "Varav pensionsinbetalning: 45 SEK"
    And I click "LOGGA UT"
    ...
    And I should see "Bruttolön inkl semesterersättning(12%): 1120"
    And I should see "Arbetsgivaravgifter(31,42%): 352"
    And I should see "Sociala avgifter(4.91%): 55"
