Feature: Annat förbunds kollektivavtal
  As a company
  In order to be able to hire people with annat förbunds kollektivavtal
...
Background:
  ...
  Given the following invoices exist
    ...
    | fisken fakturan | 1000   | 100  | 10       | fisken         | 10    | 1 | 1          | 1       | 1      | Målare sökes   | true  | true        | 0.0491     | 20  | 2018-01-01 | 1          | fisken           | 20        |
    | felix fakturan  | 1000   | 100  | 10       | felix          | 10    | 2 | 2          | 2       | 2      | Snickare sökes | true  | true        | 0.0491     | 30  | 2018-01-01 | 2          | felix            | 21        |
    | johan fakturan  | 1000   | 100  | 10       | johan          | 10    | 3 | 3          | 3       | 3      | Plåtis sökes   | true  | true        | 0.0491     | 70  | 2018-01-01 | 3          | johan            | 22        |
  ...
  Scenario: I see the invoices for under 25 with annat förbunds kollektivavtal
    ...
    And I should not see "pensionsinbetalning"
    And I should see "Sociala avgifter & försäkring(0.61%): 6 SEK"
    ...
    And I should see "Sociala avgifter & försäkring(0.61%): 7"
    And I should see "Belopp ex. moms: 1479"
    And I click "Logga ut"
  ...
  Scenario: I see the invoices for 25-65 with annat förbunds kollektivavtal
    ...
    And I should see "Utbetald summa: 713 SEK"
    And I should see "Arbetsgivaravgifter(31,42%): 320 SEK"
    And I should see "Sociala avgifter & försäkring(4.91%): 50 SEK"
    And I should see "Varav pensionsinbetalning: 44 SEK"
    And I click "Logga ut"
    ...
    And I should see "Bruttolön inkl semesterersättning(12%): 1120"
    And I should see "Arbetsgivaravgifter(31,42%): 352"
    And I should see "Sociala avgifter & försäkring(4.91%): 55"
    And I should see "Löneskatt på pensionskostnader: 12"
    And I should see "Belopp ex. moms: 1539"
    And I click "Logga ut"
    Given I am logged in as admin "admin@yahoo.com"
    Given I am on the administrations page
    And I click "Fakturor"
    ...
    And I should see "Bruttolön inkl semesterersättning: 1120 SEK"
    And I should see "Arbetsgivaravgifter: 352 SEK"
    And I should see "Sociala avgifter(4.91%): 55 SEK"
    And I should see "Löneskatt på pensionskostnader: 12 SEK"
    And I should see "Summa ex. moms: 1539"
    And I should see "User fee: 0.09"
    And I should see "Fakturabelopp exkl moms: 1539"
    And I should see "Vår avgift: -90 SEK"
    And I should see "Arbetsgivaravgifter(31,42%): -320 SEK"
    And I should see "Sociala avgifter(4.91%): -50 SEK"
    And I should see "Varav pensionsinbetalning: 44 SEK"
    And I should see "Bruttolön inkl sem. ers: 1019 SEK"
    And I should see "Skatt: -306 SEK"
    And I should see "Nettolön att utbetala: 713 SEK"

  Scenario: I see the invoices for over 65 with annat förbunds kollektivavtal
