Feature: Show freelancers
  ...
  Background:
    ...
    Given the following profiles exist
      ...
      | anders   | Erfaren snickare    | Erfaren snickare med 5 års erfarenhet            | måleri 5 år, snicker 3 år. | Från 150 kr/timma | 2            | göteborg | 2  | 2       |
      | robert   | Erfaren plåtslagare | Erfaren plåtslagare med 5 års erfarenhet         | måleri 5 år, snicker 3 år. | Från 150 kr/timma | 3            | göteborg | 3  |         |
