Feature: Hängavtal kollektivavtal
  As a company
  In order to be able to hire people with hängavtal kollektivavtal
...
Background:
  ...
  Given the following invoices exist
    ...
    | fisken fakturan | 1000   | fisken         | 15    | 1 | 1          | 1       | 1      | Målare sökes   | true  | true        | 0.0501     | 20  | 2018-01-01 | 1          | fisken           |
    | felix fakturan  | 1000   | felix          | 15    | 2 | 2          | 2       | 2      | Snickare sökes | true  | true        | 0.0501     | 30  | 2018-01-01 | 2          | felix            |
    | johan fakturan  | 1000   | johan          | 15    | 3 | 3          | 3       | 3      | Plåtis sökes   | true  | true        | 0.0501     | 70  | 2018-01-01 | 3          | johan            |

  Scenario: I see the invoices for under 25 with hängavtal kollektivavtal
    ...
    And I should not see "pensionsinbetalning"
    And I should see "Sociala avgifter(0.71%): 7 SEK"
    ...
    And I should see "Sociala avgifter(0.71%): 8"
    And I should see "Belopp ex. moms: 1480"
    And I click "LOGGA UT"
    ...
    And I should see "Summa ex. moms: 1480"
    And I should see "User fee: 0.1"
    And I should see "Fakturabelopp exkl moms: 1480"
  ...
  Scenario: I see the invoices for 25-65 with hängavtal kollektivavtal
    ...
    And I should see "Bruttolön inkl semesterersättning(12%): 1120"
    And I should see "Arbetsgivaravgifter(31,42%): 352"
    And I should see "Sociala avgifter(5.01%): 56"
    And I should see "Löneskatt på pensionskostnader: 12"
    And I should see "Belopp ex. moms: 1540"
    And I click "LOGGA UT"
    Given I am logged in as admin "admin@yahoo.com"
    Given I am on the administrations page
    And I click "Fakturor"
    ...
    And I should see "Bruttolön inkl semesterersättning: 1120 SEK"
    And I should see "Arbetsgivaravgifter: 352 SEK"
    And I should see "Sociala avgifter(5.01%): 56 SEK"
    And I should see "Löneskatt på pensionskostnader: 12 SEK"
    And I should see "Summa ex. moms: 1540"
    And I should see "User fee: 0.1"
    And I should see "Fakturabelopp exkl moms: 1540"
    And I should see "Vår avgift: -147 SEK"
    And I should see "Arbetsgivaravgifter(31,42%): -317 SEK"
    And I should see "Sociala avgifter(5.01%): -51 SEK"
    And I should see "Varav pensionsinbetalning: 43 SEK"
  ...
  Scenario: I see the invoices for over 65 with hängavtal kollektivavtal
